...
sed 's/HEAP="-Xms512m -Xmx512m"/HEAP="-Xms1024m -Xmx10240m"/' /home/azureuser/apache-jmeter-3.3/bin/jmeter_bkup > /home/azureuser/apache-jmeter-3.3/bin/jmeter
chmod 755 /home/azureuser/apache-jmeter-3.3/bin/jmeter
chown azureuser:azureuser /home/azureuser/apache-jmeter-3.3/bin/jmeter
